...
## Execution Steps
- [x] **Task 1 — Define reproducible workload fixtures**: Generate small and representative large SQLite/JSONL datasets for Codex, Devin, OpenCode/MiMoCode and directory scanners, including append, rewrite and unchanged cases. Keep private logs out of fixtures.
...
- [x] **Task 3 — Publish budgets and prioritize measured hotspots**: Document the target's measured scope, results and gaps; correct the nonexistent helper reference in AGENTS.md without weakening the governance target. Rank follow-up cache slices using measured cost.
