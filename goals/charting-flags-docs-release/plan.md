...
- [ ] **Task 5 — Release**: HELD by request. Feature work is complete; the version cut waits until every goal is done so the release lands as one change. Do not merge the release-please pull request before then.
