...
- [ ] **Phase 1 — Schema & Core Loader Implementation**:
...
- [ ] **Phase 2 — Unit & Edge Case Testing**:
...
- [ ] **Phase 3 — Verification & Live Smoke Test**:
  - Run `go test -v -race ./...`.
...
- [ ] **Phase 5 — Goal Closure & Pre-Release Checklist Execution**:
