...
- [x] **Phase 1: Tool Name & `--help` (Issues 2 & 3)**:
...
- [x] **Phase 2: Pricing Estimates on Leaderboard and Dashboard (Issue 1)**:
...
- [x] **Phase 3: Telemetry Invariant in Analytics (Issue 4)**:
...
- [x] **Phase 4: UI Redesign of `thermal stats` (Issue 5)**:
...
- [x] **Phase 5: Verification & Documentation Parity**:
